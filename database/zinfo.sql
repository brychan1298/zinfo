...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2023 at 01:50 AM
...
(37, 2, 'ROSSA 25 SHINING YEARS CONCERT (PALEMBANG)', 'Merayakan 25 tahun karir Rossa di industri musik Indonesia. Inspire IDN akan mengadakan konser offline di 4 kota berbeda. Setelah menahan rindu selama 2 tahun akibat pandemi, pada tahun 2022 Rossa akan langsung menyapa pecinta Rossa di kota Jakarta, Bandung, Surabaya, Medan, Lampung, Kuala Lumpur dan Palembang.', '35.png', 300000, '2022-11-26', 'Palembang', 'Palembang Icon Mall, Jl. Pom Ix No. 1, Lorok Pakjo, Kec Ilir Bar. I, Kota Palembang, Sumatera Selatan 30137', 'Offline', 50, '', 'Scarlett', '@scarlett_whitening', 'marketing@scarlettwhitening.com', NULL),
(38, 1, 'Go Scholarship 2022', 'Go Scholarship 2022 proudly present\r\n\r\n“𝙀𝙣𝙧𝙞𝙘𝙝 𝙮𝙤𝙪𝙧 𝘼𝙗𝙞𝙡𝙞𝙩𝙮, 𝙐𝙣𝙡𝙤𝙘𝙠 𝙮𝙤𝙪𝙧 𝙣𝙚𝙬 𝙊𝙥𝙥𝙤𝙧𝙩𝙪𝙣𝙞𝙩𝙮”\r\n\r\nAn Inspiring with our awardees from several well-known scholarships and “𝐏𝐚𝐫𝐚𝐦𝐚 𝐏𝐫𝐚𝐝𝐚𝐧𝐚 𝐒𝐮𝐭𝐞𝐣𝐚” as our guest star!', '36.png', 0, '2022-11-05', 'Zoom', 'Zoom', 'Online', 50, '', 'FEB Universitas Airlangga, Departemen Adkesma', '@Goscholarship2022', 'humas@feb.unair.ac.id', NULL),
(39, 1, 'Pekan Raya Biologi 2022', '37.jpeg', '', 0, '2022-09-17', 'Sleman', 'Jl. Marsda Adisucipto', 'Offline', 50, '', 'Universitas Islam Negeri Sunan Kalijaga', '@prbuinsuka2022', 'fst@uin-suka.ac.id', NULL),
(40, 1, 'LAWFERENCE', '[KSM DEBATE AND MOOTCOURT SOCIETY FAKULTAS HUKUM UNIVERSITAS SURABAYA x PSEUDORECHTSPRAAK FAKULTAS HUKUM UNIVERSITAS DIPONEGORO] \r\n\r\n⚖ LAWFERENCE ⚖ \r\n\r\nWEBINAR NASIONAL KOLABORATIF HIMPUNAN KOMUNITAS PERADILAN SEMU WILAYAH JAWA II INDONESIA UBAYA x UNDIP ', '38.jpeg', 0, '2022-08-11', 'Zoom', 'Zoom', 'Online', 50, '', 'HIMPUNAN KOMUNITAS PERADILAN SEMU WILAYAH JAWA II INDONESIA UBAYA x UNDIP', '@undip_semarang', 'humas@unit.ubaya.ac.id', NULL),
(41, 1, 'TALKSHOW FOURTYFIVE STATION 2022', '[TALKSHOW FOURTYFIVE STATION 2022]\r\n\r\nSobat Muda mau tau peran Radio terhadap industri kreatif berbasis audio di era digital? Dengan pembicara yang sudah berpengalaman di bidangnya?!', '39.jpeg', 0, '2022-07-16', 'Depok', 'Jalan RS. Fatmawati Raya, Pd. Labu, Kec. Cilandak, Kota Depok, Jawa Barat 12450', 'Offline', 50, '', 'FORTYFIVE RADIO', '@fourtyfiveradio', 'fourtyfiveradio@upnvj.ac.id', NULL),
(42, 1, 'SEMINAR NASIONAL \" Mewujudkan Kampus yang Bersih dari Kekerasan Seksual dengan NGOJEK \"', '[Badan Eksekutif Mahasiswa Ikatan Keluarga Besar Mahasiswa Universitas Hindu Indonesia 2021/2022]\r\n\r\n✨Proundly Present✨\r\n\"SEMINAR NASIONAL\" \r\ndengan tema \r\n\"Mewujudkan Kampus yang Bersih dari Kekerasan Seksual dengan NGOJEK (Ngobrol Jenius Kekinian)\"', '40.jpg', 45000, '2022-04-23', 'Bali', 'JI. Sanggalangit, Tembau, Penatih.', 'Offline', 50, '', 'Badan Eksekutif Mahasiswa Ikatan Keluarga Besar Mahasiswa Universitas Hindu Indonesia 2021/2022', '@bem_uhnigbsdenpasar', 'infos1@unhi.ac.id', NULL),
(43, 2, 'BLACKPINK WORLD TOUR [BORN PINK] JAKARTA (GENERAL SALES)', 'BLACKPINK IN YOUR AREAAA~\r\n\r\nGrup K-pop legendaris, BLACKPINK akan datang kembali ke Jakarta untuk mempromosikan album terbaru mereka, BORN PINK melalui tur dunia mereka yang bertajuk, BLACKPINK WORLD TOUR [BORN PINK] JAKARTA pada tanggal 11 & 12 Maret 2023 di Stadion Utama Gelora Bung Karno, Jakarta!\r\n\r\nGrup beranggotakan empat orang ini akan menyapa BLINK Indonesia selama dua hari! Jadi, BLINKS, persiapkan dirimu untuk menari dan menyanyi bersama lagu-lagu hits mereka mulai dari Pink Venom, DDU-DU DDU-DU, Shut Down, BOOMBAYAH, dan masih banyak lagi!', '41.png', 1385000, '2023-03-12', 'Jakarta Pusat', 'Jakarta Pusat', 'Offline', 50, '', 'Black Pink Indonesia', '@blackpinkofficial', 'blackpink_id@gmail.com', NULL),
...
--
ALTER TABLE `transactiondetail`
  MODIFY `transactiondetailID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
